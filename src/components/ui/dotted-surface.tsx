...
export function DottedSurface({ className, ...props }: DottedSurfaceProps) {
	...
	useEffect(() => {
		...
		return () => {
			...
			// Cancel the *current* pending frame (animationId is reassigned every
			// frame, so close over it directly rather than a stale snapshot).
			...
			// Remove exactly the canvas this effect created.
